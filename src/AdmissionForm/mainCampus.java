 ...
 * @author fgbal
 */
public class mainCampus extends javax.swing.JFrame {

    /**
     * Creates new form maincamp
     */
    public mainCampus() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        bpsuHeader.setText("MAIN CAMPUS");
        ...
        mainCourseTable.setBackground(new java.awt.Color(204, 204, 204));
        mainCourseTable.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(85, 22, 29), 2));
        mainCourseTable.setForeground(new java.awt.Color(30, 30, 30));
        mainCourseTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Bachelor of Science in Accountancy", "", "Construction Engineering and Management", "STEM", "Grade 11 Final GWA 85"},
                {"Bachelor of Science in Electrical Engineering", "", null, "STEM", "Grade 11 Final GWA 80"},
                {"Bachelor of Science in Computer Engineering", null, null, "STEM", "Grade 11 Final GWA 80"},
                {"Bachelor of Science in Midwifery", "", null, "All Strands/Tracks", "Grade 11 Final GWA 80"},
                {"Bachelor of Science in Public Health", "Population Health  ", null, "STEM", "Grade 11 Final GWA 85"},
                {"Bachelor of Science in Information Technology", null, "Network and Web Application", "All Strands/Tracks", "Grade 11 Final GWA 80"},
                {"Bachelor of Arts in Communication", null, "Creative and Performing Arts", "", "Grade 11 Final GWA 80"}
            },
            new String [] {
                "PROGRAM", "MAJOR", "SPECIALIZATION", "STRAND", "MINIMUM GWA"
            }
        ));
        mainCourseTable.setColumnSelectionAllowed(true);
        jScrollPane2.setViewportView(mainCourseTable);
        mainCourseTable.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mainCampus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mainCampus().setVisible(true);
            }
        });
    }
